...
instructions(I):- 
    append(Instruc, [;|RestInstructions],I), 
    instruccion(Instruc),
...
instruccion(I):-
    append(Var,[=|Op],I),
    variable(Var),
    append(FirstOp,[+|SecondOp],Op),
    variable(FirstOp),
    variable(SecondOp),!.
    
instruccion(I):-
    append(FirstPartCond,[then|SecondPartCond],I),
    append([if], EqOp,FirstPartCond),
    append(Var1,[=|Var2],EqOp),
    variable(Var1), variable(Var2),
    append(Instr1,[else|Instr2Corrupt],SecondPartCond),
    append(Instr2,[endif],Instr2Corrupt),
    instructions(Instr1),
    instructions(Instr2),!.
