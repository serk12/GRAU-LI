...
eachIJexactlyOneK:- row(I), col(J), findall( x-I-J-K, val(K), Lits ), exactly(1,Lits), debug(Lits),fail.
eachIJexactlyOneK.

eachJKexactlyOneI:- col(J), val(K), findall( x-I-J-K, row(I), Lits ), exactly(1,Lits), debug(Lits),fail.
eachJKexactlyOneI.

eachIKexactlyOneJ:- row(I), val(K), findall( x-I-J-K, col(J), Lits ), exactly(1,Lits), debug(Lits),fail.
eachIKexactlyOneJ.

eachBlockEachKexactlyOnce:- blockID(Iid,Jid), 
        val(K), findall( x-I-J-K, squareOfBlock(Iid,Jid,I,J), Lits ), exactly(1,Lits), debug(Lits),fail.
